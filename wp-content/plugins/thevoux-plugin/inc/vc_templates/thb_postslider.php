<?php function thb_postslider( $atts, $content = null ) {
  ...
  $source .= '|offset:'.$offset;
 	...
 	if ( $posts->have_posts() ) { ?>
	<div class="<?php echo implode(' ', $classes); ?>" data-columns="1" data-pagination="<?php echo esc_attr($pagi); ?>" data-navigation="<?php echo esc_attr($nav); ?>" data-autoplay="<?php echo esc_attr($autoplay); ?>" data-autoplay-speed="<?php echo esc_attr($autoplay_speed); ?>">
