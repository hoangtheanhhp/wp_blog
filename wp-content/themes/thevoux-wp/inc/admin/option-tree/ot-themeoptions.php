  ...
  $custom_settings = array(
    ...
    'settings'        => array(
      ...
      array(
        ...
        'id'          => 'facebook_page_id',
        'type'        => 'text',
        'desc'        => __('Facebook Page ID, you can use <a href="http://findmyfbid.com/" target="_blank">this page</a> to find your id', 'thevoux'),
        'section'     => 'social'
      ),
      array(
      ...
      array(
        ...
        'id'          => 'facebook_app_id',
        'type'        => 'text',
        'desc'        => __('Facebook Application ID, available <a href="https://developers.facebook.com/apps/" target="_blank">here</a>', 'thevoux'),
        'section'     => 'social'
      ),
      array(
        ...
        'type'        => 'text',
        'desc'        => __('Facebook Application Secret, available <a href="https://developers.facebook.com/apps/" target="_blank">here</a>', 'thevoux'),
        'section'     => 'social'
      ),
      array(
        'id'          => 'social_tab4',
      ...
      array(
        ...
        'type'        => 'text',
        'desc'        => __('Visit <a href="https://dev.twitter.com/apps">this link</a> in a new tab, sign in with your account, click on Create a new application and create your own keys in case you dont have already', 'thevoux'),
        'section'     => 'social'
      ),
      array(
      ...
      array(
        ...
        'id'          => 'gp_apikey',
        'type'        => 'text',
        'desc'        => __('Visit <a href="https://console.developers.google.com/project">https://console.developers.google.com/project</a> using your Google account, click on the Create Project button and fill the form to create a project.', 'thevoux'),
        'section'     => 'social'
      ),
      array(
        'id'          => 'header_tab1',
