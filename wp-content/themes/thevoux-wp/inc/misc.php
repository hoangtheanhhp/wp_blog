...
function thb_body_classes( $classes ) {
	...
	$thb_pinit = 'thb-pinit-'.ot_get_option('thb_pinit', 'on');
...
function thb_post_icon() {
	$format = get_post_format();
	$id = get_the_ID();
	$is_review = get_post_meta($id, 'is_review', TRUE) == 'yes';
...
function thb_sponsored_setup() {
	...
	} else if ($sponsored_position == 'below-content') {
