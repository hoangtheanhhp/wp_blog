...
?>
<div id="post-gallery-<?php echo esc_attr($id); ?>" class="mfp-hide">

	<?php if ($post_gallery_photos) { foreach ($post_gallery_photos_arr as $photo_id) {echo $photo_id; ?>
				...
				<div class="small-12 medium-5 large-3 columns image-text">
					<div class="lightbox-text-content">
						...
						<?php if ($the_image->post_title && $lightbox_image_title == 'on') { ?>
							<h6><?php echo $the_image->post_title; ?></h6>
						<?php } ?>
						<?php if ($the_image->post_excerpt && $lightbox_image_caption == 'on') { ?>
							<p><?php echo $the_image->post_excerpt; ?></p>
						<?php } ?>
						<?php if ($the_image->post_content && $lightbox_image_source == 'on') { ?>
							<small><?php esc_html_e('Source:', 'thevoux'); ?> <?php echo $the_image->post_content; ?></small>
						<?php } ?>
					</div>
