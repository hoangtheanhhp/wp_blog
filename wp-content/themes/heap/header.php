...
if ( pixelgrade_option( 'nav_placement' ) == 'top' ) {
	$class_name .= '  nav-position-top';
}
if ( pixelgrade_option( 'nav_borders' ) == 0 ) {
	$class_name .= '  nav-borders-hide';
}

if ( pixelgrade_option( 'nav_separators' ) == 'dots' ) {
	$class_name .= '  nav-separator-dots';
}
if ( pixelgrade_option( 'nav_separators' ) == 'bars' ) {
	$class_name .= '  nav-separator-bars';
}

if ( pixelgrade_option( 'nav_dropdown' ) == 'caret' ) {
	$class_name .= '  nav-dropdown-caret';
}
if ( pixelgrade_option( 'nav_dropdown' ) == 'plus' ) {
...
$data_ajaxloading = ( pixelgrade_option( 'use_ajax_loading' ) == 1 ) ? 'data-ajaxloading' : '';
$class_name .= ( pixelgrade_option( 'use_ajax_loading' ) == 1 ) ? ' animations' : '';
...
<div class="wrapper  js-wrapper" id="page">
	<?php if ( pixelgrade_option( 'header_search' ) ) {
		get_template_part( 'theme-partials/header/search' );
	} ?>
	<header class="site-header">
		<div class="site-header__wrapper  js-sticky<?php if ( pixelgrade_option( 'nav_always_show' ) ) {
			...
			<div class="site-header__container">
				...
				<div class="header flexbox">
					...
					<div class="header-component  header-component--right">
						<ul class="nav  site-header__menu">
							<?php if ( pixelgrade_option( 'header_rss' ) ): ?>
								<li>
									<a href="<?php echo pixelgrade_option( 'header_rss_link' ) ?>"><i class="icon-e-rss"></i></a>
								</li>
							<?php endif;
							if ( pixelgrade_option( 'header_contact' ) ): ?>
								<li>
									<a href="mailto:<?php echo get_bloginfo( 'admin_email' ) ?>"><i class="icon  icon-envelope"></i></a>
								</li>
							<?php endif;
							if ( pixelgrade_option( 'header_search' ) ): ?>
				...
				<?php if ( pixelgrade_option( 'nav_placement' ) != 'top' ) : ?>
					<nav class="navigation  navigation--main<?php if ( ! $has_main_menu ) {
						echo "  no-menu";
					} ?>" id="js-navigation--main">
						<h2 class="accessibility"><?php _e( 'Primary Navigation', 'heap' ) ?></h2>
