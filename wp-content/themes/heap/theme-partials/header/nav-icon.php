...
// 2 => Icon + Text
// 3 => Text
$nav_trigger = pixelgrade_option('nav_trigger_style');

// 1 => Three Lines (default)
// 2 => Plus
// 3 => Dots + Lines
$nav_trigger_icon = pixelgrade_option('nav_trigger_icon');
...
function navContentText($option) {
	return '<span class="nav-text'.(($option != 3) ? ' push-half--right ' : '').'">'.pixelgrade_option( 'nav_trigger_text', __('Menu', 'heap') ).'</span>';
}
?>
