...
<div class="article__featured-image">
	<div class="pixslider js-pixslider"
		...
		foreach ($attachments as $attachment):
			...
			$thumb_img = wp_get_attachment_image_src( $attachment->ID, 'post-square-small' );
			?>
			<div class="gallery__item" itemscope itemtype="http://schema.org/ImageObject" >
				<img src="<?php echo $thumb_img[0]; ?>" class="attachment-medium-size  rsImg  invisible" alt="" itemprop="contentURL" />
			</div>
