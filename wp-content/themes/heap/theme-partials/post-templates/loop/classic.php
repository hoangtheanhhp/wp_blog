...
$has_sidebar = false;
if (pixelgrade_option('blog_show_sidebar')) {
	$has_sidebar = true;
}
...
//infinite scrolling
$mosaic_classes = '';
if (pixelgrade_option('blog_infinitescroll')) {
	$mosaic_classes .= ' infinite_scroll';
	$classes .=' inf_scroll';

	if (pixelgrade_option('blog_infinitescroll_show_button')) {
...
<div class="page-content  blog-archive <?php echo $classes ?>">
	...
	if (pixelgrade_option('blog_show_breadcrumb')) heap_breadcrumb();
	...
	if (pixelgrade_option('blog_infinitescroll') && pixelgrade_option('blog_infinitescroll_show_button') && ($wp_query->max_num_pages > 1)): ?>
		<div class="load-more__container">
			<button class="load-more__button"><?php echo pixelgrade_option('blog_infinitescroll_button_text') ?></button>
		</div>
	<?php endif;
	else:
